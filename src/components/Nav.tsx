  ...
  return (
    <header className="sticky top-0 z-50 bg-[var(--color-paper)]/95 backdrop-blur">
      ...
      <div className="rule-bottom">
        <div className="mx-auto max-w-[1200px] px-5 py-5 flex items-center justify-between gap-6">
          <Link href="/" className="flex items-center gap-3.5 shrink-0">
            <Seal className="w-14 h-14 shrink-0 text-[var(--color-forest-800)]" />
            <div className="leading-tight">
              <div className="font-display font-bold text-[2.1rem] md:text-[2.5rem] leading-[0.95] tracking-tight text-[var(--color-forest-950)]">
                Canna-Safe Programs
              </div>
              <div className="font-mono text-[11px] tracking-[0.16em] uppercase text-[var(--color-ink-muted)] mt-1.5">
